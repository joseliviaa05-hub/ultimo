        ...
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              console.log('📝 Marcando pedido como completado:', pedido.id);
              
              const resultado = await marcarPedidoCompletado(pedido.id);
              
              console.log('✅ Respuesta del servidor:', resultado);
              
              // Actualizar el estado local
              const pedidoActualizado = { ...pedido, estado: 'completado' };
                ...
                [
                  {
                    text: 'OK',
                    onPress: () => {
                      // ✅ CRÍTICO: Notificar a la pantalla anterior que debe recargar
              ...
              Alert.alert(
                'Error', 
                error.response?.data?.error || 'No se pudo completar el pedido'
              );
            } finally {
              setLoading(false);
            }
