...
// ✅ ESTILOS (sin cambios, los mismos del archivo original)
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: Colors.background },
  centerContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: Colors.background },
  loadingText: { marginTop: 16, fontSize: 16, color: Colors.gray },
  headerContainer: { backgroundColor: Colors.white, paddingTop: 16, paddingHorizontal: 16, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: Colors.lightGray },
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.background, borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10, marginBottom: 12, gap: 8 },
  searchInput: { flex: 1, fontSize: 16, color: Colors.dark },
  contadorContainer: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingVertical: 8 },
  contadorText: { fontSize: 12, color: Colors.gray, fontWeight: '500' },
  listContainer: { padding: 16, paddingBottom: 80 },
  emptyContainer: { alignItems: 'center', paddingVertical: 64, paddingHorizontal: 32 },
  emptyEmoji: { fontSize: 64, marginBottom: 16 },
  emptyTitle: { fontSize: 20, fontWeight: 'bold', color: Colors.dark, marginBottom: 8, textAlign: 'center' },
  emptyText: { fontSize: 14, color: Colors.gray, textAlign: 'center', lineHeight: 20 },
  emptyButton: { marginTop: 16, paddingVertical: 10, paddingHorizontal: 20, backgroundColor: Colors.primary, borderRadius: 8 },
  emptyButtonText: { color: Colors.white, fontSize: 14, fontWeight: '600' },
  fabButton: { position: 'absolute', right: 16, bottom: 16, width: 56, height: 56, borderRadius: 28, backgroundColor: Colors.primary, justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 8 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.5)', justifyContent: 'flex-end' },
  modalContainer: { backgroundColor: Colors.white, borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingTop: 8, maxHeight: '80%' },
  ...
  input: { backgroundColor: Colors.background, borderRadius: 8, padding: 12, fontSize: 16, color: Colors.dark, borderWidth: 1, borderColor: Colors.lightGray },
  hint: { fontSize: 12, color: Colors.gray, marginTop: 4, lineHeight: 16 },
  warningBox: { flexDirection: 'row', gap: 12, padding: 12, backgroundColor: Colors.background, borderRadius: 8, borderLeftWidth: 4, borderLeftColor: Colors.primary },
  warningText: { flex: 1, fontSize: 13, color: Colors.gray, lineHeight: 18 },
  modalButtons: { flexDirection: 'row', gap: 12, padding: 20, borderTopWidth: 1, borderTopColor: Colors.lightGray },
  cancelButton: { flex: 1, paddingVertical: 14, borderRadius: 12, backgroundColor: Colors.background, alignItems: 'center', justifyContent: 'center' },
