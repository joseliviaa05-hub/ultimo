...
const ClientesScreen = ({ navigation }) => {
  ...
  const cargarClientes = async () => {
    try {
      ...
      // ✅ FIX: Extraer array de clientes correctamente
      let clientesArray = [];
      ...
      if (data.clientes && Array.isArray(data.clientes)) {
        ...
        clientesArray = data;
      } else if (data.success && data.clientes && Array.isArray(data.clientes)) {
        clientesArray = data.clientes;
      } else {
      ...
      console.log(`✅ ${clientesArray.length} clientes cargados`);
